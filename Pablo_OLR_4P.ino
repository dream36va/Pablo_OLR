...
#define PIN_LED        2    // R 500 ohms to DI pin for WS2812 and WS2813, for WS2813 BI pin of first LED to GND 
#define PIN_P1         A2    // switch player 1 to PIN A0 and GND
#define PIN_P2         A0    // switch player 2 to PIN A1 and GND 
#define PIN_P3         A1    // switch player 3 to PIN A2 and GND
#define PIN_P4         A3    // switch player 4 to PIN A3 and GND 
#define PIN_AUDIO     3    // BUZZER
